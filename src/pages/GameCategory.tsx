      ...
      <Layout>
        {categoryData.map((item) => {
          ...
          return (
            <GameCategoryCard
              key={id}
              representCategoryName={representCategoryName}
              representCategoryKoreanName={representCategoryKoreanName}
...
const GAME_CATEGORY_DATA = [
  ...
  id: item[0],
  representCategoryName: item[1],
  representCategoryKoreanName: item[2],
  summarization: item[3],
  description: item[4],
}));
